var Master = {
	Organism: [
		...
		{id:'Lab', name:'lactic acid bacteria', picture:'(LAB)Lactic acid bacteria.jpg', additive:['lactic_acid', 'sorbic_acid', 'acetic_acid', 'nitrite'], title:'<h1>lactic <small> acid bacteria</small></h1>'},
		{id:'Lm', name:'Listeria monocytogenes/innocua', picture:'(Lm)Listeria_monocytogenes.jpg', title:'<h1>Listeria <small> monocytogenes/innocua</small></h1>'},
